...
type KubernetesConfig struct {
	...
	TryLimit                                          int                                `toml:"try_limit,omitzero" json:"try_limit" long:"try-limit" env:"KUBERNETES_REQUEST_TRY_LIMIT" default:"5" description:"The maximum number of attempts to communicate with Kuberntes API. There is 500 miliseconds interval between each attempt"`
